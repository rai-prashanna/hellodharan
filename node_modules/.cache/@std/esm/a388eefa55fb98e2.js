"main";let join;_55f‍.w('path',[["join",function(v){join=v}]]);let writeFile;_55f‍.w('fs',[["writeFile",function(v){writeFile=v}]]);let promisify;_55f‍.w('util',[["promisify",function(v){promisify=v}]]);let address,date,random;_55f‍.w('faker',[["address",function(v){address=v}],["date",function(v){date=v}],["random",function(v){random=v}]]);let starwars;_55f‍.w('starwars',[["default",function(v){starwars=v}]]);let starWarsWords;_55f‍.w('forcem-ipsum',[["default",function(v){starWarsWords=v}]]);let mkdirp;_55f‍.w('mkdirp',[["default",function(v){mkdirp=v}]]);let _;_55f‍.w('lodash',[["default",function(v){_=v}]]);let uuid;_55f‍.w('uuid/v4',[["default",function(v){uuid=v}]]);let ora;_55f‍.w('ora',[["default",function(v){ora=v}]]);let User,Comment,Like,Post;_55f‍.w('./models',[["User",function(v){User=v}],["Comment",function(v){Comment=v}],["Like",function(v){Like=v}],["Post",function(v){Post=v}]]);
