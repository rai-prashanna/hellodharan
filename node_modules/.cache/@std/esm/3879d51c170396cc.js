"use script";"main";(function() {
	var forcem = (function() {
		var forcem = function(option, limit) {
			...
			for (i = 0; i < limit; i++) {
				if ( option == 'e4' || option == 'episode4' || option == 'episode 4' ) {
					output.push(content.episode.four[i]);
				} else if ( option == 'e5' || option == 'episode5' || option == 'episode 5' ) {
					output.push(content.episode.five[i]);
				} else if ( option == 'e6' || option == 'episode6' || option == 'episode 6' ) {
					output.push(content.episode.six[i]);
				} else if ( option == 'planets' || option == 'places' ) {
					output.push(content.planets[i]);
				} else if ( option == 'characters' || option == 'people' ) {
					output.push(content.characters[i]);
				}
			}
			return output;
		};
